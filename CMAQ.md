...
|    PNETCDF   |    1.9.0     | https://parallel-netcdf.github.io/Release/parallel-netcdf-1.9.0.tar.gz     |
...
1. Run the following commands to install PNETCDF:
    ...
    ./configure --prefix=/path/to/PNETCDF --build=aarch64-unknown-linux-gnu --enable-relax-coord-bound CFLAGS="-fPIC -DPIC" CXXFLAGS="-fPIC -DPIC" FCFLAGS="-fPIC" FFLAGS="-fPIC" CC=mpicc CXX=mpicxx FC=mpifort F77=mpifort
    make -j $(nproc)
    make install
2. Configure environment variables:
...
1. Run the following command to obtain the source code package:
    ...
    wget -O CMAQ-CMAQv5.3.1_19Dec2019.tar.gz https://codeload.github.com/USEPA/CMAQ/tar.gz/CMAQv5.3.1_19Dec2019
...
5. Edit the configuration file.
   ...
   open the file of ioapi/Makeinclude.Linux4_aarch64 ,and set: 
...
8. Edit the configuration file.
   ...
   open the file of m3tools/Makefile ,and set:
...
10. Edit the configuration file.
    ...
    open the file of Makefile ,and set:
...
12. Modify the STATE3.EXT file.
    ...
    open the file of ioapi/STATE3.EXT ,and delete & at the end of some lines in the STATE3.EXT file.
...
14. Edit the configuration file.
    ...
    open the file of bldit_project.csh ,and set:
...
17. Edit the configuration file.
    ...
    open the file of config_cmaq.csh ,and set:
