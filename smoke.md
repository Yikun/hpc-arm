...
|  SMOKE | smoke_v481.Linux2_x86_64ifort.tar.gz smoke_v481.nctox.data.tar.gz smoke_install_v481.csh  | https://github.com/CEMPD/SMOKE/releases  |
### OS Requirements
...
8. Create and Modify the Makefile file
   ...
   a. Run the vi Makefile command.

   b. Press i to enter the insert mode and modify the file as follows:
...
9. Modify the Makeinclude.Linux2_aarch64gfort file
   ...
   a. Run the vi Makeinclude.Linux2_aarch64gfort command.
...
2. Modify the configuration file.
   ...
   a. Run the vi ASSIGNS.nctox.cmaq.cb05_soa.us12-nc command.

   b. Press i to enter the insert mode and modify line 25 as follows:
...
3. Modify the Makeinclude file.
   ...
   a. cd $SMK_HOME/subsys/smoke/src

   b. vi Makeinclude

   c. Press i to enter the insert mode and modify the file as follows:
...
4. Modify the smkinven/rdinvsrcs.f file.
   ...
   a. Run the vi smkinven/rdinvsrcs.f command.
   
   b. Press i to enter the insert mode and change the type of the GETPID function from INTEGER*4 to INTRINSIC.

   c. Press Esc, enter :wq!, and press Enter to save the file and exit.
5. Modify the smkinven/rdemspd.f file.

   a. Run the vi smkinven/rdemspd.f command.

   b. Press i to enter the insert mode and Add a capital letter "C" on line 304 to comment on code 304.
